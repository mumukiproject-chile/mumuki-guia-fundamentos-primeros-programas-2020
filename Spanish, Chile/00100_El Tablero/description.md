Para empezar a programar, el primer elemento que vamos a usar es un **tablero** cuadriculado, similar al del ajedrez, del juego de damas o del [Go](http://es.wikipedia.org/wiki/Go).
